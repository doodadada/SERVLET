...
<!--
	...
	간단히 해결하기 위해 만들어진 출력 문법, jsp 의 문법을 html5 에서 좀 더 구분하기 쉽고,
...
request.setAttribute("name2","홍길서");
...
<!--
EL 을 이용할 때 서버객체의 내용을 출력하고자 할 때, 어떤 객체인지 명시하지 안혹, 애트리뷰터 이름만
사용한다면, 사용하려는 애트리뷰트 가 있는 객체를 순서(pageContext -> request -> session -> application)
순서로 검사하여 가장 먼저 발견된 내용이 출력됩니다.
name 이라는 애트리뷰트를 갖고 있는 객체중에서 순서적으로 가장 우선인 객체 내용이 출력됩니다
-->
