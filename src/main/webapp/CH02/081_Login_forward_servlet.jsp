...
<body>
<!-- 서블릿과 포워드를 이용한 로그인 처리(데이터베이스 X) -->
<form method="post" action="../login.do">
		<label for="id">아이디 : </label><input type="text" id="id" name="id" value="hong"><br>
		<label for="pwd">암 &nbsp; 호 : </label><input type="password" name="pwd" value="1234"><br>
...
<!-- 
	...
	현재 로그인 구조는 WAS 서버를 이용할 예정이고, 서블릿을 이용한 처리릃 할 예정입니다
